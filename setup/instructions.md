...
1. In the remote shell, run the following command:
  ...
  ```
  The script will take about 10 minutes to run and finishes by setting a password for the 'centos' user.
1. **IMPORTANT**: Take note of the password generated by the script. You will need it to connect using RDP.
